...
public class ParkComplVO {

	private int compl_seq;
	
	private String compl_park_tag_id;
	...
	public String getCompl_park_tag_id() {
		return compl_park_tag_id;
	}

	public void setCompl_park_tag_id(String compl_park_tag_id) {
		this.compl_park_tag_id = compl_park_tag_id;
	}
	...
	public String toString() {
		return "ParkComplVO [compl_seq=" + compl_seq + ", compl_park_tag_id=" + compl_park_tag_id + ", compl_category="
				+ compl_category + ", compl_content=" + compl_content + ", complt_name=" + complt_name
				+ ", complt_phone=" + complt_phone + ", complt_email=" + complt_email + ", complt_compl_cr_dt="
				+ complt_compl_cr_dt + "]";
	}
