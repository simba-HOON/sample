							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 padding-left1">
								<div class="contact">
									...
									<form class="moveDetailForm" method="get">
										<div class="row">
											<div class="col-sm-12">
												<label style="font-size:20px;">민원인 이름</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletComplDetail.complt_name}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원인 연락처</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletComplDetail.complt_phone}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원인 이메일</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletComplDetail.complt_email}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원인 카테고리</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletComplDetail.compl_category}'/>">
											</div>
										</div>
									</form>
									<form class="moveDetailForm2" method="get">
										<div class="row">
											<div class="col-sm-12">
												<label style="font-size:20px;">민원 내용</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletComplDetail.compl_content}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원 발생 공원 아이디</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletComplDetail.compl_toilet_tag_id}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원 순번</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletComplDetail.compl_seq}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원 등록일자</label>
												<input type="date" style="font-size:20px;" class="contactus" readonly="readonly" value='<fmt:formatDate value="${toiletComplDetail.complt_compl_cr_dt}" pattern="yyyy-MM-dd"/>'>
											</div>
										</div>
									</form>
							
									<div class="col-sm-12">
												<a type="button" class="backBtn" href='/toiletCompl'>화장실 민원 목록</a>				
									</div>
								</div>
							</div>
