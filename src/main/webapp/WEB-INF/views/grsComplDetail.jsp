									...
									<form class="moveDetailForm" method="get">
										<div class="row">
											<div class="col-sm-12">
												...
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsComplDetail.complt_name}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원인 연락처</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsComplDetail.complt_phone}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원인 이 메일</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsComplDetail.complt_email}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원인 알림 방식</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsComplDetail.complt_noti_type}'/>">
											</div>
										</div>
									</form>
									<form class="moveDetailForm2" method="get">
										<div class="row">
											<div class="col-sm-12">
												...
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsComplDetail.compl_content}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원처리 상태</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsComplDetail.compl_state}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원 처리 결과 전송여부</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsComplDetail.compl_result_send_yn}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원 등록일자</label>
												<input type="date" style="font-size:20px;" class="contactus" readonly="readonly" value='<fmt:formatDate value="${grsComplDetail.complt_compl_cr_dt}" pattern="yyyy-MM-dd"/>'>
											</div>
										</div>
									</form>
							
									<div class="col-sm-12">
												<a type="button" class="backBtn" href='/grsCompl'>가로수 민원 목록</a>				
									</div>
								</div>
							</div>
