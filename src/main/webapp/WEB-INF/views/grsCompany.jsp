...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<a href="/grsCompany">
						<h1 class="h3 mb-2 text-gray-800">가로수 업체목록</h1>
					</a>
					<p class="mb-4">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div>
								<div class="col-sm-12 col-md-6">
									<form id="searchForm3" action="/grsCompany" method="get">
						...
						<div class="row">
							...
							<div class="dataTables_info">
								<a href="/grsCompanyExcelDown" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
						...
						<form id="moveForm3" action="/grsCompany" method="get">
	...
	<script type="text/javascript">
		...
		$(".move").on("click", function(e){
			...
			moveForm3.attr("action", "/grsCompanyDetail");
			moveForm3.submit();
