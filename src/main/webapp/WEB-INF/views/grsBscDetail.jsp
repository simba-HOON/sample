							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 padding-left1">
								<div class="contact">
									...
									<form class="moveDetailForm" method="get">
										<div class="row">
											<div class="col-sm-12">
												<label style="font-size:20px;">가로수 수목명</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsBscDetail.grs_nm}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">시행처 (기관)</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsBscDetail.impl_cp_id}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">관리작업 회사</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsBscDetail.wk_cp_id}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">작업자</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsBscDetail.wk_seq}'/>">
											</div>
										</div>
									</form>
									<form class="moveDetailForm2" method="get">
										<div class="row">
											<div class="col-sm-12">
												<label style="font-size:20px;">가로수 주소</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsBscDetail.grs_addr}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">가로수 크기 (수고)</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsBscDetail.tr_height}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">병충해 피해</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsBscDetail.pest_dmg_state}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">가로수 정보 생성일자</label>
												<input type="date" style="font-size:20px;" class="contactus" readonly="readonly" value='<fmt:formatDate value="${grsBscDetail.bsc_info_cr_dt}" pattern="yyyy-MM-dd"/>'>
											</div>
										</div>
									</form>
							
									<div class="col-sm-12">
												<a type="button" class="backBtn" href='/grsBsc1'>가로수 기본 목록</a>				
									</div>
								</div>
							</div>
