...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<a href="/toiletBsc">
						<h1 class="h3 mb-2 text-gray-800">화장실 관리현황</h1>
					</a>
					<p class="mb-4">
						현재 등록되어 있는 화장실 현황을 나타내고 있습니다.&nbsp;&nbsp;&nbsp;&nbsp;또한, 화장실 이름으로 "찾기"를 통해 해당되는 가로수를 검색할 수 있습니다.
					</p>

					<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">전체 화장실 테이블</h6>
						</div>
						<div class="card-body">
									<div class="row">
										
										<div class="col-sm-12 col-md-6">
												<form id="searchForm" action="/toiletBsc" method="get">
									...
									<div class="row">
										<div class="col-sm-12">
											<table class="table table-bordered dataTable" width="100%">
												...
												<tbody>
													<tr class="odd">
														<td class="sorting_1"><c:out value="${list.toilet_tag_id}"></c:out></td>
														<td class="sorting_1">
															<a class="move" href='<c:out value="${list.toilet_tag_id}"/>'>
																<c:out value="${list.toilet_nm}"></c:out>
															</a>
														</td>														
														<td class="sorting_1"><c:out value="${list.toilet_owner}"></c:out></td>														
														<td class="sorting_1"><c:out value="${list.toilet_impl_cp_id}"></c:out></td>
														<td class="sorting_1"><c:out value="${list.toilet_wk_cp_id}"></c:out></td>
														<td class="sorting_1"><fmt:formatDate value="${list.toilet_bsc_info_cr_dt}" pattern="yyyy-MM-dd"/></td>
													</tr>
												</tbody>														
												</c:forEach>														
											</table>
									...
									<div class="row">
										...
										<div class="dataTables_info">
											<a href="/toiletBscExcelDown" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
										...
										<div class="col-sm-12 col-md-7">											
											...
											<form id="moveForm" action="/toiletBsc" method="get">
	...
	<script type="text/javascript">
		...
		$(".move").on("click", function(e){
			...
			moveForm.append("<input type='hidden' name='toilet_tag_id' value='"+$(this).attr("href")+"'>");
			moveForm.attr("action", "/toiletBscDetail");
			moveForm.submit();
