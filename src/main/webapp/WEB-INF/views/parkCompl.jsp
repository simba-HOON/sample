...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<a href="/parkCompl">
						<h1 class="h3 mb-2 text-gray-800">공원 민원 관리</h1>
					</a>
					<p class="mb-4">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">민원 발생현황 테이블</h6>
						</div>
						
						<div class="card-body">
							<div class="col-sm-12 col-md-6">
									<form id="searchForm2" action="/parkCompl" method="get">
							...
							<div>							
								<table class="table table-bordered" width="100%">
									...
									<tbody>
										...
										<tr>
											<td><c:out value="${list2.compl_park_tag_id}"></c:out></td>
											<td><c:out value="${list2.compl_category}"></c:out></td>
											<td>
												<a class="move" href='<c:out value="${list2.compl_park_tag_id}"/>'>
						...
						<div class="row">
							...
							<div class="dataTables_info">
								<a href="/parkComplExcelDown" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
						...
						<form id="moveForm2" action="/parkCompl" method="get">
	...
	<script type="text/javascript">
		...
		$(".move").on("click", function(e){
			...
			moveForm2.append("<input type='hidden' name='compl_park_tag_id' value='"+$(this).attr("href")+"'>");
			moveForm2.attr("action", "/parkComplDetail");
			moveForm2.submit();
