							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 padding-left1">
								<div class="contact">
									...
									<form class="moveDetailForm" method="get">
										<div class="row">
											<div class="col-sm-12">
												<label style="font-size:20px;">화장실 아이디</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletBscDetail.toilet_tag_id}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">화장실 이름</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletBscDetail.toilet_nm}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">화장실 소유자 </label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletBscDetail.toilet_owner}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">화장실 작업 회사</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletBscDetail.toilet_impl_cp_id}'/>">
											</div>
										</div>
									</form>
									<form class="moveDetailForm2" method="get">
										<div class="row">
											<div class="col-sm-12">
												...
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletBscDetail.toilet_wk_cp_id}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">화장실 작업순번</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletBscDetail.toilet_wk_seq}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">화장실 일련번호</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${toiletBscDetail.toilet_seq}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">화장실 정보 생성일자</label>
												<input type="date" style="font-size:20px;" class="contactus" readonly="readonly" value='<fmt:formatDate value="${toiletBscDetail.toilet_bsc_info_cr_dt}" pattern="yyyy-MM-dd"/>'>
											</div>
										</div>
									</form>
							
									<div class="col-sm-12">
												<a type="button" class="backBtn" href='/toiletBsc'>화장실 기본 목록</a>				
									</div>
								</div>
							</div>
