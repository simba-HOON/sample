									...
									<form class="moveDetailForm" method="get">
										<div class="row">
											<div class="col-sm-12">
												...
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkComplDetail.complt_name}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원인 연락처</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkComplDetail.complt_phone}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원인 이메일</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkComplDetail.complt_email}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원인 카테고리</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkComplDetail.compl_category}'/>">
											</div>
										</div>
									</form>
									<form class="moveDetailForm2" method="get">
										<div class="row">
											<div class="col-sm-12">
												...
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkComplDetail.compl_content}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원 발생 공원 아이디</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkComplDetail.compl_park_tag_id}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원 순번</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkComplDetail.compl_seq}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">민원 등록일자</label>
												<input type="date" style="font-size:20px;" class="contactus" readonly="readonly" value='<fmt:formatDate value="${parkComplDetail.complt_compl_cr_dt}" pattern="yyyy-MM-dd"/>'>
											</div>
										</div>
									</form>
							
									<div class="col-sm-12">
												<a type="button" class="backBtn" href='/parkCompl'>공원 민원 목록</a>				
									</div>
								</div>
							</div>
