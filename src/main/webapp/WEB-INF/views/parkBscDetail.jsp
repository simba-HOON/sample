							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 padding-left1">
								<div class="contact">
									...
									<form class="moveDetailForm" method="get">
										<div class="row">
											<div class="col-sm-12">
												<label style="font-size:20px;">공원 이름</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkBscDetail.park_nm}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">공원 소유자</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkBscDetail.park_owner}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">공원 관리부 </label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkBscDetail.park_impl_cp_id}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">공원 작업부</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkBscDetail.park_wk_cp_id}'/>">
											</div>
										</div>
									</form>
									<form class="moveDetailForm2" method="get">
										<div class="row">
											<div class="col-sm-12">
												<label style="font-size:20px;">공원 순번</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkBscDetail.park_seq}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">공원 작업순번</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkBscDetail.park_wk_seq}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">공원 아이디</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${parkBscDetail.park_tag_id}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">공원 정보 생성일자</label>
												<input type="date" style="font-size:20px;" class="contactus" readonly="readonly" value='<fmt:formatDate value="${parkBscDetail.park_bsc_info_cr_dt}" pattern="yyyy-MM-dd"/>'>
											</div>
										</div>
									</form>
							
									<div class="col-sm-12">
												<a type="button" class="backBtn" href='/parkBsc'>공원 기본 목록</a>				
									</div>
								</div>
							</div>
