...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<a href="toiletCompany">
						<h1 class="h3 mb-2 text-gray-800">화장실 업체 관리</h1>
					</a>
					<p class="mb-4">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div>
								<div class="col-sm-12 col-md-6">
									<form id="searchForm3" action="/toiletCompany" method="get">
						...
						<div class="row">
							...
							<div class="dataTables_info">
								<a href="/toiletCompanyExcelDown" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
								<i class="fas fa-download fa-sm text-white-50"></i>엑셀파일 다운로드</a>										
							</div>
							</div>
						...
						<form id="moveForm3" action="/toiletCompany" method="get">
	...
	<script type="text/javascript">
		...
		$(".move").on("click", function (e) {
			...
			moveForm3.attr("action", "/toiletCompanyDetail");
			moveForm3.submit();
		});
	</script>
