...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<a href="/grsCompl">				
						<h1 class="h3 mb-2 text-gray-800">가로수 민원 관리</h1>
					</a>	
					<p class="mb-4">
						현재 등록되어 있는 민원 현황을 나타내고 있습니다.&nbsp;&nbsp;&nbsp;&nbsp;또한, 민원 내용으로 "찾기"를 통해 해당되는 민원을 검색할 수 있습니다.
					</p>

					<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">민원 발생 현황 테이블</h6>
						</div>
						
						<div class="card-body">
							<div class="col-sm-12 col-md-6">
									<form id="searchForm2" action="/grsCompl" method="get">
							...
							<div>							
								<table class="table table-bordered" width="100%">
									...
									<tbody>
										...
										<tr>
											<td><c:out value="${list2.compl_grs_tag_id}"></c:out></td>
											<td><c:out value="${list2.compl_category}"></c:out></td>
											<td>
												<a class="move" href='<c:out value="${list2.compl_grs_tag_id}"/>'>
													<c:out value="${list2.compl_content}"></c:out>
												</a>
											</td>
											<td><c:out value="${list2.complt_name}"></c:out></td>
											<td><c:out value="${list2.complt_noti_type}"></c:out></td>
						...
						<div class="row">
							...
							<div class="dataTables_info">
								<a href="/grsComplExcelDown" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
						...
						<form id="moveForm2" action="/grsCompl" method="get">
	...
	<script type="text/javascript">
		...
		$(".move").on("click", function(e){
			...
			moveForm2.append("<input type='hidden' name='compl_grs_tag_id' value='"+$(this).attr("href")+"'>");
			moveForm2.attr("action", "/grsComplDetail");
			moveForm2.submit();
