									...
									<form class="moveDetailForm" method="get">
										<div class="row">
											<div class="col-sm-12">
												...
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsCompanyDetail.cor_reg_no}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">업체 명</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsCompanyDetail.company_nm}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">대표자 명</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsCompanyDetail.president_nm}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">업종</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsCompanyDetail.company_busi}'/>">
											</div>
										</div>
									</form>
									<form class="moveDetailForm2" method="get">
										<div class="row">
											<div class="col-sm-12">
												...
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsCompanyDetail.company_id}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">업체 전화번호</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsCompanyDetail.company_tel}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">업체 주소</label>
												<input style="font-size:20px;" class="contactus" readonly="readonly" value="<c:out value='${grsCompanyDetail.company_addr}'/>">
											</div>
											<div class="col-sm-12">
												<label style="font-size:20px;">업체 등록일자</label>
												<input type="date" style="font-size:20px;" class="contactus" readonly="readonly" value='<fmt:formatDate value="${grsCompanyDetail.sys_cr_dt}" pattern="yyyy-MM-dd"/>'>
											</div>
										</div>
									</form>
							
									<div class="col-sm-12">
										<a type="button" class="backBtn" href='/grsCompany'>가로수 업체 목록</a>				
									</div>
								</div>
							</div>
