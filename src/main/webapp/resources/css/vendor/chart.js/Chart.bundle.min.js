    ...
    var lt = X.extend({
            ...
            draw: function () {
                ...
                if ((e.save(), (e.fillStyle = n.backgroundColor), (e.strokeStyle = n.borderColor), a.fullCircles)) {
                    for (a.endAngle = a.startAngle + rt, e.beginPath(), e.arc(a.x, a.y, a.outerRadius, a.startAngle, a.endAngle), e.arc(a.x, a.y, a.innerRadius, a.endAngle, a.startAngle, !0), e.closePath(), t = 0; t < a.fullCircles; ++t)
                        e.fill();
        ...
        mi = e(function (e, n) {
            e.exports = (function () {
                ...
                function Ft(t, e, n) {
                    t.isValid() &&
                        !isNaN(n) &&
                        ("FullYear" === e && Ct(t.year()) && 1 === t.month() && 29 === t.date() ? t._d["set" + (t._isUTC ? "UTC" : "") + e](n, t.month(), It(n, t.month())) : t._d["set" + (t._isUTC ? "UTC" : "") + e](n));
                }
                function It(t, e) {
                    ...
                    if (!t._d) {
                        for (
                            i = (function (t) {
                                ...
                                null != t._dayOfYear &&
                                    ((o = be(t._a[vt], i[vt])), (t._dayOfYear > Dt(o) || 0 === t._dayOfYear) && (g(t)._overflowDayOfYear = !0), (n = jt(o, 0, t._dayOfYear)), (t._a[bt] = n.getUTCMonth()), (t._a[yt] = n.getUTCDate())),
                                e = 0;
                            e < 3 && null == t._a[e];
                            ++e
                        )
